...
Send a pull request to [assignments/mgmt-groups/mg-HMCTS/assign.allowed_sa_sku.json](https://github.com/hmcts/cpp-azure-policy/blob/HEAD/assignments/mgmt-groups/mg-HMCTS/assign.allowed_sa_sku.json) with justification for why you need to use one not on the standard list.
